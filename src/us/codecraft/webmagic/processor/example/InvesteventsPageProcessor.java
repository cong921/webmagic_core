...
public class InvesteventsPageProcessor implements PageProcessor {
...
//		Spider spider = Spider.create(new InvesteventsPageProcessor());
			Spider.create(new InvesteventsPageProcessor()).addUrl("https://www.itjuzi.com/investevents?prov=北京&location=in&scope=1&round=12&currency=1&date=2016&page=1").addPipeline(new FilePipeline("D:/test12")).run();
